...
module.exports = class {
    ...
    http(req, res, next = () => res.end('')) {
        ...
        if (typeof this.config.whitelist == 'object' && this.config.whitelist.length != 0) {
            if (!this.config.whitelist.includes(proxyURL.hostname)) isBlocked = true;
        } else{
            isBlocked = false;
        }

        if (isBlocked) return res.end('<!DOCTYPE html> <html> <head> <title>Error</title> <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /> </head> <body> <div class="d-flex justify-content-md-center align-items-center vh-100 p-5"> <div> <div class="row"> <div class="col-md-12"> <h1>This URL is unavailable</h1> <p>Try going back or refreshing the page</p> </div> </div> <div class="row"> <div class="col-md-12"> <p>If you believe this is an error please email us at mnichols@themaddoxnetwork.com and let us know</p> </div> </div> <!-- footer with logo --> <div class="row"> <div class="col-md-12"> <p><img src="/static/images/favicons/favicon-230x230.png" alt="TMN Logo" class="img-responsive mx-auto d-block" /></p> </div> <div class="row"> <div class="col-md-12"> <hr /> <p>© The Maddox Network</p> <small>URL: ' + proxyURL.hostname + '</div> </div> </div> </body> </html>')
            ...
            proxyResponse.on('data', data => rawData.push(data)).on('end', () => {
                ...
                proxify.url = url => {
                 ...
                 proxify.html = body => {
                    ...
                    //Add Powered By to make it clear that this is a proxy
                    var poweredBy = document.createElement('div');
                    poweredBy.innerHTML = '<div><h3 style="color:#fff; font-size:23px">Powered By TMN Bypass 3.0</h3><p style="color:#fff; font-size:13px">Do not enter any sensitive information on this site</p></div>';
                    poweredBy.style.position = 'fixed';
                    poweredBy.style.background = '#000';
                    poweredBy.style.pointerEvents = 'none';
                    poweredBy.style.zIndex = '9999999999';
                    poweredBy.style.right = '15px';
                    poweredBy.style.bottom = '10px';
                    poweredBy.style.padding = '5px';
                    poweredBy.style.opacity = '0.6';
                    poweredBy.style.color = '#fff';
                    poweredBy.style.fontSize = '13px';
                    poweredBy.style.fontFamily = 'Arial, sans-serif';
                    poweredBy.style.lineHeight = 'initial';
                    poweredBy.style.width = 'auto';
                    document.body.appendChild(poweredBy);

                    //Add tracking matomo script
                    var matomoScript = document.createElement('script');
                    matomoScript.type = 'text/javascript';
                    matomoScript.innerHTML = "var _paq = window._paq = window._paq || [];  _paq.push(['trackPageView']); _paq.push(['enableLinkTracking']); (function() { var u='https://tmnlabs.com/static/services/analytics/'; _paq.push(['setTrackerUrl', u+'matomo.php']); _paq.push(['setSiteId', '3']); var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0]; g.async=true; g.src=u+'matomo.js'; s.parentNode.insertBefore(g,s); })();";
